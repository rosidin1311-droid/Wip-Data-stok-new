...
export default function BottomNavbar({ activeTab, setActiveTab }: BottomNavbarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center px-4 pb-4 pointer-events-none">
      <div className="relative w-full max-w-md h-20 grid grid-cols-5 items-center justify-items-center pointer-events-auto bg-red-975 dark:bg-red-950/95 backdrop-blur-md text-white rounded-2xl shadow-2xl border border-red-800/55 shadow-[0_-4px_20px_rgba(239,68,68,0.25)]">
        ...
        {/* Column 3: Data Stock (Floating Action Button Column) */}
        <div className="relative w-full h-full flex flex-col items-center justify-center">
          <div className="absolute top-[-24px] flex flex-col items-center">
            ...
            <span className="text-[10px] font-bold text-red-500 dark:text-red-400 mt-1.5 drop-shadow uppercase tracking-wider text-center whitespace-nowrap">
              STOK
            </span>
          </div>
        </div>

        {/* Column 4: Riwayat Tab */}
        <button
          id="nav-riwayat"
